    ...
    if not summary.empty:
        ...
        if target_asset:
            ...
            if not hist_data.empty:
                ...
                score_color = "#34d399" if ai_rating >= 7 else ("#d4af37" if ai_rating >= 4 else "#fb7185")
...
# ==========================================
# 9. MÓDULO FÁCIL: PORTAFOLIO SIMPLIFICADO
# ==========================================
else:
